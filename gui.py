...
class mainWindow(QMainWindow):
    ...
    #File Menu Operations
        ...
        newWarClaim.triggered.connect(self.createWarrantyClaim)
        newOnOrd.triggered.connect(self.createOnlineOrder)
    ...
    #Draw the window
        ...
        create.clicked.connect(self.theWindowArea.createSpecialOrder)
        edit.clicked.connect(self.theWindowArea.editSpecialOrder)
        delete.clicked.connect(self.theWindowArea.delete)
    ...
    def createOnlineOrder(self):
        ...
        self.wLayout = QFormLayout()
        self.wLayout.addRow("Fist Name", self.custFirstName)
        ...
        self.w.show()
        self.sendOrder.clicked.connect(self.sendRequest)
    ...
    def sendRequest(self):
        ...
        self.data = {
            ...
            'link':self.theWindowArea.createWooProduct(
...
# Order Realted Functions
    ...
    def createSpecialOrder(self):
        ...
        self.wLayoutCust.addRow("Fist Name", self.custFirstName)
